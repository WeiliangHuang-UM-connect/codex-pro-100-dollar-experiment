...
**2026-09-21 更正：SABLE 历史约定 250 美元、已验收未到账；原付款评论已改为历史／已取代模式说明，当前无新结算确认；2026-09-21 用户已要求停止跟进。以下带日期记录保留当时观察，不代表现时付款承诺。详见[核查证据](../evidence/sable-status-2026-09-21.json)。**
...
2026-09-19T19:00:05+08:00：用户明确授权后，PayPal 收款信息通过 Gmail 发往买方指定私下渠道，并核实已发送记录。[Issue 告知](https://github.com/socksninja/sable-agent-reliability/issues/54#issuecomment-5741269484)已发布。收款资料不公开；等待付款，到账 0。
